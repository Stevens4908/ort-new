    ...
    <div className="row py-5 justify-content-center">
        <div className="col-md-6 text-center list-group-item list-group-item">
            <form className='py-5'>
                ...
                <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nomina"/>             
                </div>
                ...
                <div className="form-group p-1">
                    ...
                    <input type="number" className="form-control" id="exampleInputPassword1" placeholder="Cedula"/>
                </div>
                ...
                <div className="form-group p-1">
                    ...
                    <input type="text" className="form-control" id="exampleInputPassword1" placeholder="Cargo"/>
                </div>
                ...
                <button type="submit" className="btn btn-primary fondo-ortellus mt-4">REGISTRAR</button>
